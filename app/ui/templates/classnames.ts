...
export const btn = {
  primary:
    `${r} inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-zinc-900 text-white text-sm font-semibold shadow-sm hover:bg-zinc-700 active:scale-[0.98] active:bg-zinc-800 transition-all duration-150 cursor-pointer select-none`,
  secondary:
    `${r} inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl border border-zinc-300 bg-white text-sm font-semibold text-zinc-800 shadow-sm hover:bg-zinc-50 hover:border-zinc-400 active:scale-[0.98] transition-all duration-150 cursor-pointer select-none`,
  ghost:
    `${r} inline-flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-sm font-medium text-zinc-500 hover:text-zinc-900 hover:bg-zinc-100 active:bg-zinc-200 active:scale-[0.98] transition-all duration-150 cursor-pointer select-none`,
  danger:
    `${r} inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-red-600 text-white text-sm font-semibold shadow-sm hover:bg-red-500 active:scale-[0.98] active:bg-red-700 transition-all duration-150 cursor-pointer select-none`,
};
...
export const navLink = {
  ...
  active:
    `${m} relative text-zinc-100 font-semibold text-sm uppercase tracking-widest after:absolute after:-bottom-1 after:left-0 after:h-px after:w-full after:bg-zinc-100`,
  brand:
    `${m} text-lg font-extrabold tracking-tighter text-white hover:text-zinc-300 transition-colors duration-150 drop-shadow-[0_0_12px_rgba(255,255,255,0.15)]`,
};
...
export const link = {
  ...
  subtle:
    `${r} text-sm text-zinc-400 hover:text-zinc-600 underline-offset-4 hover:underline transition-colors duration-150`,
...
export const tag = {
  primary:
    `${r} inline-flex items-center text-xs font-semibold px-2.5 py-1 rounded-full bg-zinc-900 text-zinc-100`,
  secondary:
    `${r} inline-flex items-center text-xs font-medium px-2.5 py-1 rounded-full bg-zinc-100 text-zinc-600 border border-zinc-200`,
  muted:
    `${r} inline-flex items-center text-xs font-medium px-2.5 py-1 rounded-full bg-zinc-50 text-zinc-400 border border-zinc-200`,
};
